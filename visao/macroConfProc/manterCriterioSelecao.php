...
<html>
    <head>     
        <title>Gerenciar Critério de Seleção - Seleção EAD</title>
    ...
    <body>  
        ...
        <div id="main">
            <div id="container" class="clearfix">
                ...
                <div id="breadcrumb">
                    <h1>Você está em: <a href="<?php print $CFG->rwww; ?>/visao/processo/listarProcessoAdmin.php">Editais</a> > <a href="<?php print $CFG->rwww; ?>/visao/processo/manterProcessoAdmin.php?<?php print Util::$ABA_PARAM; ?>=<?php print Util::$ABA_MPA_AVALIACAO; ?>&idProcesso=<?php print $processo->getPRC_ID_PROCESSO(); ?>">Gerenciar</a> > <strong><?php if (!$edicao) { ?> Cadastrar Critério de Seleção <?php } else { ?> Editar Critério de Seleção <?php } ?></strong></h1>
                </div>
                ...
                <div class="contents completo m02 p15">
                    ...
                    <form class="form-horizontal" id="formCadastro" method="post" action="<?php print $CFG->rwww; ?>/controle/CTNotas.php?acao=<?php !$edicao ? print "criarMacroConfProc" : print "editarMacroConfProc" ?>">
                        ...
                        <input type="hidden" name="tipoMacro" value="<?php print MacroConfProc::$TIPO_CRIT_SELECAO; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8">
                                <?php impressaoTipoMacro(MacroConfProc::$TIPO_CRIT_SELECAO, $edicao ? $macroConfProc->getMCP_DS_MACRO() : NULL, $edicao); ?>
                            </div>
                        </div>
        ...
        $(document).ready(function () {
            ...
            var gatTipo = function () {
                ...
                $.ajax({
                    ...
                    data: {"idProcesso": '<?php print $processo->getPRC_ID_PROCESSO(); ?>', "idEtapaAval": '<?php print $idEtapaAvalTela; ?>', "tipoMacro": '<?php print MacroConfProc::$TIPO_CRIT_SELECAO; ?>', "idTipoMacro": $("#idTipoMacro").val(), "edicao": <?php $edicao ? print "true" : print "false"; ?>, "idMacroConfProc":<?php $edicao ? print $macroConfProc->getMCP_ID_MACRO_CONF_PROC() : print "''"; ?>},
                    dataType: "json",
