...
<html>
    <head>     
        <title>Visualizar Recurso - Seleção EAD</title>
    ...
    <body>  
        ...
        <div id="main">
            <div id="container" class="clearfix">
                ...
                <div id="breadcrumb">
                    <h1>Você está em: <a href="<?php print $CFG->rwww ?>/visao/processo/listarProcessoAdmin.php">Editais</a> > <a href = "<?php print $CFG->rwww ?>/visao/recurso/listarRecursoProcesso.php?idProcesso=<?php print $inscricao->getPRC_ID_PROCESSO(); ?>">Recursos</a> > <strong>Consultar</strong></h1>
                </div>
                ...
                <div class="col-full">
                    <form id="formRecurso" class="form-horizontal" method="post" action=''>
                        ...
                        <fieldset class="m02">
                            ...
                            <div class="col-full">
                                <div class="form-group">
                                    ...
                                    <?php impressaoSitRecurso($recurso->getRRP_ST_SITUACAO(), TRUE); ?>
                                </div>
                                <div class="form-group">
                                    <label>Descrição da Análise:</label>
                                    <textarea class="form-control" disabled id="dsAnalise" cols="60" rows="10" style="width: 100%;" name="dsAnalise"><?php print $recurso->getRRP_DS_ANALISE(FALSE); ?></textarea>
                        ...
                        <div class="col-full m02">
                            <input type="button" class="btn btn-default" onclick="javascript: window.location = '<?php print $CFG->rwww ?>/visao/recurso/listarRecursoProcesso.php?idProcesso=<?php print $inscricao->getPRC_ID_PROCESSO(); ?>';" value="Voltar">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            adicionaContadorTextArea(3000, "dsJustificativa", "contador");

            adicionaContadorTextArea(3000, "dsAnalise", "contadorAnalise");
