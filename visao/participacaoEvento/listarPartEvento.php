...
<html>
    <head>     
        <title>Part. em Eventos - Seleção EAD</title>
        ...
        //criando filtros
        $filtro = new FiltroPartEvento($_GET, 'listarPartEvento.php', getIdUsuarioLogado());

        //criando objetos de paginação
        $paginacao = new Paginacao('tabelaPartEventoCandPorFiltroCT', 'contarPartEventoCandPorFiltroCT', $filtro);
        ?>
            ...
            <div id="container" class="clearfix">
                ...
                <div class="col-full">
                    <ul class="nav nav-tabs m02 curriculo">
                        ...
                        <li class="active"><a href="#">Participação em Evento</a></li>
                    ...
                    $avisoBtCriar = $podeAltCurriculo ? "title='Cadastrar nova participação em evento'" : "title='" . getMsgErroEdicaoCurriculo() . "' disabled";
                    $onclickBt = $podeAltCurriculo ? "javascript: window.location = 'criarPartEvento.php';" : "javascript: return false;";
                    ?>

                    <div class="col-full m01">
                        <input class="btn btn-primary m01" type="button" onclick="<?php echo $onclickBt; ?>" value="Nova participação" <?php echo $avisoBtCriar; ?>>
                    </div>
        ...
        $(document).ready(function () {
            function sucInsercao() {
                $().toastmessage('showToast', {
                    text: '<b>Participação em Evento cadastrada com sucesso.</b>',
                    sticky: false,
                    type: 'success',
                    position: 'top-right'
                });
            ...
            function sucExclusao() {
                $().toastmessage('showToast', {
                    text: '<b>Participação em Evento excluída com sucesso.</b>',
                    sticky: false,
                    type: 'success',
                    position: 'top-right'
                });
            ...
            function sucAtualizacao() {
                $().toastmessage('showToast', {
                    text: '<b>Participação em Evento atualizada com sucesso.</b>',
                    sticky: false,
                    type: 'success',
                    position: 'top-right'
                });
