...
<html>
    <head>     
        <title>Executar Avaliação Automática - Seleção EAD</title>
        ...
        // verificando se é necessário exibir aviso
        $avisoDepAvalAuto = isset($_GET[Mensagem::$TOAST_VAR_GET]) && $_GET[Mensagem::$TOAST_VAR_GET] == "execAvalAuto";
        ?>
    ...
    <body>  
        ...
        <div id="main">
            <div id="container" class="clearfix">
                ...
                <div id="breadcrumb">
                    <h1>Você está em: <a href="<?php print $CFG->rwww ?>/visao/processo/listarProcessoAdmin.php">Editais</a> > <a href="<?php print $CFG->rwww ?>/visao/inscricaoProcesso/listarInscricaoProcesso.php?idProcesso=<?php print $processo->getPRC_ID_PROCESSO(); ?>">Inscrições</a> > <strong>Avaliação Automática</strong></h1>
                </div>
                ...
                <?php if ($avisoDepAvalAuto) { ?>
                    <div class="completo">
                        <div class="callout callout-warning">
                            <strong>Você precisa executar a avaliação automática </strong> antes de executar essa operação. Por favor, siga as instruções abaixo.
                        </div>
                    </div>
                <?php } ?>

                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form id="form" class="form-horizontal" method="post" action='<?php print "$CFG->rwww/controle/CTNotas.php?acao=avaliacaoAutomatica" ?>'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8" style="padding:0 15px;">
                                        <div class="callout callout-warning" style="margin:0px;">
                                            ...
                                            <b>Confirmo que o sistema pode executar as avaliações automáticas</b>. Sei que após essa operação, não será mais possível executar a avaliação cega das inscrições avaliadas.
                        ...
                        <div id="divBotoes">
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-4 col-md-4">&nbsp;</label>
                                <div class="col-xs-12 col-sm-8 col-md-8">
                                    <input disabled id="submeter" class="btn btn-success"  type="submit" value="Avaliar">
                ...
                <div id="divMensagem" class="col-md-12 col-sm-12 col-xs-12" style="display:none">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var gatilhoTipo = function () {
                ...
                $.ajax({
                    type: "POST",
                    url: getURLServidor() + "/controle/CTAjax.php?val=avaliacaoAutomatica",
