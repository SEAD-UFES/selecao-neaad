...
<html>
    <head>  
        <title>Consultar Candidato - Seleção EAD</title>
        ...
        // recuperando dados do candidato
    ...
    <body>  
        ...
        <div id="main">
            <div id="container" class="clearfix">
                ...
                <div id="breadcrumb">
                    <h1>Você está em: Cadastros > <a href="<?php print $CFG->rwww; ?>/visao/candidato/listarCandidato.php">Candidato</a> > <strong>Consultar</strong></h1>
                </div>
                        ...
                        <div class="painel">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse">
                                <div class="panel-body">
                                    ...
                                    <b>CPF:</b> <?php print $objIdent->getNrCPFMascarado(); ?> <separador class='barra'></separador> 
                                    <b>Email:</b> <?php print $objUsuario->getUSR_DS_EMAIL(); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-full m02">
                    <div class="tabbable"> 
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab1" data-toggle="tab">Identificação</a></li>
                            <li><a href="#tab2" data-toggle="tab">Endereço / Contato</a></li>
                            <li><a href="#tab3" data-toggle="tab">Formação</a></li>
                            <li><a href="#tab4" data-toggle="tab">Publicação</a></li>
                            <li><a href="#tab5" data-toggle="tab">Part. em Evento</a></li>
                            <li><a href="#tab6" data-toggle="tab">Atuação</a></li>
                        </ul>
                    ...
                    <div class="completo m02">
                        <button class="btn btn-default" type="button" onclick="window.location = '<?php echo "$CFG->rwww/visao/candidato/listarCandidato.php"; ?>'" >Voltar</button>
                    </div>
                </div>
            </div>
        </div>  
